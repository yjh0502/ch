...
fn main() {
    ...
    let smesh = args.get_one::<String>("smesh").unwrap().parse::<u32>().unwrap();
    let slink = args.get_one::<String>("slink").unwrap().parse::<u32>().unwrap();
    let snode = args.get_one::<String>("snode").unwrap().parse::<u32>().unwrap();

    let emesh = args.get_one::<String>("emesh").unwrap().parse::<u32>().unwrap();
    let elink = args.get_one::<String>("elink").unwrap().parse::<u32>().unwrap();
    let enode = args.get_one::<String>("enode").unwrap().parse::<u32>().unwrap();
